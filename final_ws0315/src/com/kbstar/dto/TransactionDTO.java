...
public class TransactionDTO {
	...
	public TransactionDTO(String id, String myAcc, String opositAcc, String type, Double amount, Double balance, Date regdate) {
		this.id = id;
		this.myAcc = myAcc;
		this.opositAcc = opositAcc;
		this.type = type;
	...
	public String toString() {
		return "TransactionDTO [id=" + id + ", myAcc=" + myAcc + ", opositAcc=" + opositAcc + ", type=" + type + ", amount="
